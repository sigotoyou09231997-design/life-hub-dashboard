...
import { BookHeart, CalendarDays, ChevronLeft, ChevronRight, Mail, Pencil, Plane, Plus, RotateCcw, Settings as SettingsIcon, StickyNote, Trash2, Wallet, type LucideIcon } from "lucide-react";
...
const FEATURES: FeatureLink[] = [
  ...
  { to: "/diary", label: "日記", icon: BookHeart, color: "text-rose-500", bg: "bg-rose-50" },
